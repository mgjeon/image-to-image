...
if __name__ == "__main__":
    ...
    real_input  = torch.randn((batch_size,  in_channels, img_size, img_size))  # Input
    real_target = torch.randn((batch_size, out_channels, img_size, img_size))  # Target
    print("Input")
    ...
    model = UViT(
        img_size=img_size,
        in_chans=in_channels+out_channels,
